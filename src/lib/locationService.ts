...
export async function getBestLocation(): Promise<LocationResult> {
  ...
  if (browser) {
    ...
    if (
      ...
      /*
       * Reverse-geocode the actual detected coordinates.
       *
       * This determines the nearest useful populated area
       * dynamically. No town or country is hard-coded.
       */
      const reverse =
      ...
      console.log(
        "ECOS MAP: Detected nearest local area:",
        localArea
      );
    ...
    /*
     * Even when the GPS result is approximate, reverse-geocode
     * it so the application can identify the nearest useful
     * town/area without inventing a location.
     */
    const reverse =
      await reverseGeocode(
        browser.coordinates
    ...
    console.log(
      "ECOS MAP: Approximate nearest local area:",
      localArea
    );
 ...
 * ============================================================
 *
 * Select the most useful populated area returned by
 * reverse geocoding.
 *
 * No town, city, country, or coordinate is hard-coded.
 */
export function getBestLocalArea(
